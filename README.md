...
* try skip frames to optimize the computational time; however, process of skipping frame is quite slower; therefore, try frame.cpp before running darknet-cpp
